...
func TestCompositeIdentityStrategy(t *testing.T) {
	strat, err := identity.NewCompositeIdentityStrategy([]string{"warehouse_id", "item.part_number"}, ":")
	if err != nil {
